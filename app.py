...
model = torch.hub.load("ultralytics/yolov5", "custom", path = "dior/best.pt", force_reload=True)
...
model1 = torch.hub.load("ultralytics/yolov5", "custom", path = "tgrs/best.pt", force_reload=True)
...
@app.route("/notebook2")
def notebook2():
    return render_template("TGRS.html")
